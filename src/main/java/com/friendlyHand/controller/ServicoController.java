...
public class ServicoController {
	...
	public Servico getAllServicos(@PathVariable("id_servico") int idServico) {
		return servicoService.getServico(idServico);
	}
	
	@RequestMapping(method=RequestMethod.POST, value="/prestador/{id_prestador}/servico")
	public Servico createServico(@PathVariable("id_prestador") int idPrestador,@RequestBody Servico servico) {
	...
	public Servico updateServico(@PathVariable("id_prestador") int idPrestador,@PathVariable("id_servico") int idServico,@RequestBody Servico servico) {
