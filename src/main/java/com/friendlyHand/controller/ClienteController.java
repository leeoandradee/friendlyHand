...
public class ClienteController {
	...
	public Cliente getCliente(@PathVariable("id") int id) throws FileNotFoundException, ClassNotFoundException, IOException{
		return clientService.getCliente(id);
	}
	
	@RequestMapping(method=RequestMethod.POST, value="/cliente")
	public Cliente createCliente(@RequestBody Cliente cliente) throws FileNotFoundException, ClassNotFoundException, IOException{
		return clientService.createCliente(cliente);	
	}
	
	@RequestMapping(method=RequestMethod.PUT, value="/cliente/{id}")
	public Cliente atualizarCliente(@RequestBody Cliente cliente, @PathVariable("id") int id) throws FileNotFoundException, ClassNotFoundException, IOException{
		return clientService.updateCliente(cliente, id);	
	}

	@RequestMapping(method=RequestMethod.DELETE, value="cliente/{id}")
	public MensagemRetorno deleteCliente(@PathVariable("id") int id) throws FileNotFoundException, ClassNotFoundException, IOException{
